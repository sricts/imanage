...
def prepare_mpl_package():
    ...
    #                                      'static-assets'))
    FIXTURE_DIR =  "D:\Roshin\workspace\deployPortal\static-assets\murano_packages"
...
def prepare_hot_package(filepath):
    ...
    LOGO = CUSTOM_PACKAGE_DIR+os.sep+"custom_package_default_logo.png"    
    args = InitArgs()
    ...
    zip_files(package_dir,ZIP_DIR+os.sep+"custom"+os.sep+args.full_name)
    
    return ZIP_DIR+os.sep+"custom"+os.sep+args.full_name+".zip"    
